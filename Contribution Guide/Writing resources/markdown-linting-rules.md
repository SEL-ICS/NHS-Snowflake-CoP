...
This document contains a description of all rules, what they are checking for, as well as examples of documents that break the rule and corrected versions of the examples.

This is a local cached copy of the rules documentation published by [David Anson](https://github.com/DavidAnson) available at [Github: Markdownlint](https://github.com/DavidAnson/markdownlint/blob/main/doc/Rules.md)

## Contents

- [Markdown linting rules](#markdown-linting-rules)
  - [Contents](#contents)
  - [`MD001` - Heading levels should only increment by one level at a time](#%60md001%60---heading-levels-should-only-increment-by-one-level-at-a-time)
  - [`MD003` - Heading style](#%60md003%60---heading-style)
  - [`MD004` - Unordered list style](#%60md004%60---unordered-list-style)
  - [`MD005` - Inconsistent indentation for list items at the same level](#%60md005%60---inconsistent-indentation-for-list-items-at-the-same-level)
  - [`MD007` - Unordered list indentation](#%60md007%60---unordered-list-indentation)
  - [`MD009` - Trailing spaces](#%60md009%60---trailing-spaces)
  - [`MD010` - Hard tabs](#%60md010%60---hard-tabs)
  - [`MD011` - Reversed link syntax](#%60md011%60---reversed-link-syntax)
  - [`MD012` - Multiple consecutive blank lines](#%60md012%60---multiple-consecutive-blank-lines)
  - [`MD013` - Line length](#%60md013%60---line-length)
  - [`MD014` - Dollar signs used before commands without showing output](#%60md014%60---dollar-signs-used-before-commands-without-showing-output)
  - [`MD018` - No space after hash on atx style heading](#%60md018%60---no-space-after-hash-on-atx-style-heading)
  - [`MD019` - Multiple spaces after hash on atx style heading](#%60md019%60---multiple-spaces-after-hash-on-atx-style-heading)
  - [`MD020` - No space inside hashes on closed atx style heading](#%60md020%60---no-space-inside-hashes-on-closed-atx-style-heading)
  - [`MD021` - Multiple spaces inside hashes on closed atx style heading](#%60md021%60---multiple-spaces-inside-hashes-on-closed-atx-style-heading)
  - [`MD022` - Headings should be surrounded by blank lines](#%60md022%60---headings-should-be-surrounded-by-blank-lines)
  - [`MD023` - Headings must start at the beginning of the line](#%60md023%60---headings-must-start-at-the-beginning-of-the-line)
  - [`MD024` - Multiple headings with the same content](#%60md024%60---multiple-headings-with-the-same-content)
  - [`MD025` - Multiple top-level headings in the same document](#%60md025%60---multiple-top-level-headings-in-the-same-document)
  - [`MD026` - Trailing punctuation in heading](#%60md026%60---trailing-punctuation-in-heading)
  - [`MD027` - Multiple spaces after blockquote symbol](#%60md027%60---multiple-spaces-after-blockquote-symbol)
  - [`MD028` - Blank line inside blockquote](#%60md028%60---blank-line-inside-blockquote)
  - [`MD029` - Ordered list item prefix](#%60md029%60---ordered-list-item-prefix)
  - [`MD030` - Spaces after list markers](#%60md030%60---spaces-after-list-markers)
  - [`MD031` - Fenced code blocks should be surrounded by blank lines](#%60md031%60---fenced-code-blocks-should-be-surrounded-by-blank-lines)
  - [`MD032` - Lists should be surrounded by blank lines](#%60md032%60---lists-should-be-surrounded-by-blank-lines)
  - [`MD033` - Inline HTML](#%60md033%60---inline-html)
  - [`MD034` - Bare URL used](#%60md034%60---bare-url-used)
  - [`MD035` - Horizontal rule style](#%60md035%60---horizontal-rule-style)
  - [`MD036` - Emphasis used instead of a heading](#%60md036%60---emphasis-used-instead-of-a-heading)
  - [`MD037` - Spaces inside emphasis markers](#%60md037%60---spaces-inside-emphasis-markers)
  - [`MD038` - Spaces inside code span elements](#%60md038%60---spaces-inside-code-span-elements)
  - [`MD039` - Spaces inside link text](#%60md039%60---spaces-inside-link-text)
  - [`MD040` - Fenced code blocks should have a language specified](#%60md040%60---fenced-code-blocks-should-have-a-language-specified)
  - [`MD041` - First line in a file should be a top-level heading](#%60md041%60---first-line-in-a-file-should-be-a-top-level-heading)
  - [`MD042` - No empty links](#%60md042%60---no-empty-links)
  - [`MD043` - Required heading structure](#%60md043%60---required-heading-structure)
  - [`MD044` - Proper names should have the correct capitalization](#%60md044%60---proper-names-should-have-the-correct-capitalization)
  - [`MD045` - Images should have alternate text (alt text)](#%60md045%60---images-should-have-alternate-text-(alt-text))
  - [`MD046` - Code block style](#%60md046%60---code-block-style)
  - [`MD047` - Files should end with a single newline character](#%60md047%60---files-should-end-with-a-single-newline-character)
  - [`MD048` - Code fence style](#%60md048%60---code-fence-style)
  - [`MD049` - Emphasis style](#%60md049%60---emphasis-style)
  - [`MD050` - Strong style](#%60md050%60---strong-style)
  - [`MD051` - Link fragments should be valid](#%60md051%60---link-fragments-should-be-valid)
  - [`MD052` - Reference links and images should use a label that is defined](#%60md052%60---reference-links-and-images-should-use-a-label-that-is-defined)
  - [`MD053` - Link and image reference definitions should be needed](#%60md053%60---link-and-image-reference-definitions-should-be-needed)
  - [`MD054` - Link and image style](#%60md054%60---link-and-image-style)
  - [`MD055` - Table pipe style](#%60md055%60---table-pipe-style)
  - [`MD056` - Table column count](#%60md056%60---table-column-count)
  - [`MD058` - Tables should be surrounded by blank lines](#%60md058%60---tables-should-be-surrounded-by-blank-lines)
  - [`MD059` - Link text should be descriptive](#%60md059%60---link-text-should-be-descriptive)
